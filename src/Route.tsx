...
import { SaleBord } from "./components/SaleBord"
    ...
    return (
        <HashRouter>
            <Routes>
                ...
                <Route path="/storeproducts" element={<> <Navbar/> <StoreProducts/> <SaleBord/> </> } />
                <Route path="/salebord" element={<> <StoreProducts/> <SaleBord/> </> } />
